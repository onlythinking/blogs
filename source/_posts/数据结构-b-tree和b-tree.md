...
![image-20211125153852383](/images/image-20211125153852383.png)
...
![btree-insert](/images/btree-insert.gif)
...
![btree-del](/images/btree-del.gif)
...
![btree-del2](/images/btree-del2.gif)
...
![B_Tree_Simplified_Leaf_Page](/images/B_Tree_Simplified_Leaf_Page.png)

非叶子节点包含**子页面的页码**和指向的**子页面的最小键**。

![B_Tree_Simplified_Non_Leaf_Page](/images/B_Tree_Simplified_Non_Leaf_Page.png)

同级节点之间，每个节点**上一页**和**下一页**的指针，形成同一级别页面的双向链表。

![B_Tree_Simplified_Level](/images/B_Tree_Simplified_Level.png)

综上索引结构如下，同级页面形成双向链接，在每个页面内记录升序链接，非叶页面包含子页面“指针”（子页码）。

![B_Tree_Structure](/images/B_Tree_Structure.png)
